...
class ImageRecognizer(object):
    ...
    def recognize_face(imageURI):
        ...
        face_folder = os.path.abspath(os.path.join(os.path.dirname(sys.argv[0]), '..', '..', 'logicshare', 'backend', 'face'))
        data = pickle.loads(open(os.path.join('face', encoding_file), "rb").read())
